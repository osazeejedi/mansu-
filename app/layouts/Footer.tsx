...
const quickLinksItems = [
  ...
  { id: 1, text: "Partnership", href: "partnership" },
  { id: 1, text: "Our Services", href: "our-services" },
...
const homeItems = [
  ...
  { id: 1, text: "Partnership", href: "partnership" },
  { id: 1, text: "Info@mansu.io", href: "mailto:Info@mansu.io" },
];
      ...
      <div className="container mx-auto px-4 py-10 md:py-14">
        <div className="grid grid-cols-1 md:grid-cols-6">
          <div className="flex flex-col col-span-1 md:col-span-3">
            <div>
              <Image src="/logo_full.svg" alt="logo" width={100} height={80} />
            </div>
